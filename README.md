...
Quarto projeto do curso de programação aqui desenvolveremos todos os conceitos aplicados até agora.

## Imagem do projeto

![Projeto](./formulario.gif)

## Aprendizados

Nesse projeto irá aprender à realizar um formulário com validações utilizadno HTML, CSS e JS.
...
```bash
  git clone git@github.com:GuilhermeFMP/Projeto-4-TrybeWarts.git
  cd Trybe-Pixels-Art
  npm install
```
